...
const SBMCard = () => {
  ...
  return (
    <>
      <div className="poemBG poemBG-SBM tab:h-[100vh] flex flex-col tab:flex-row  tab:items-center tab:justify-center tab:bsorder-4 border-black border-double gradient-border ">
