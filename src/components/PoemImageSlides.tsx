...
const PoemImageSlides = () => {
  ...
  const renderSlide = (id: number, quote: string, speaker: string) => (
    <div
      className={`quoteBG quoteBG${id} PISlides h-[35vh] text-center text-white text-[14px] md:text-[16px] nxl:text-[22px] px-[10vw] rounded-tr-[0px] srounded-bl-[40px] tab:rounded-bl-[60px] nxl:rounded-bl-[100px] w3-animate-opacitys drop-shadow-2xl mb-6 mt-2`}
      key={id}
    >
