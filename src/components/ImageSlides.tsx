...
//         <div className="quoteBG quoteBG1 mySlides h-[40vh] lg:h-[50vh] flex flex-col items-center justify-center text-center text-white text-[14px] md:text-[16px] nxl:text-[22px] px-[10vw] rounded-tr-[0px] rounded-bl-[40px] tab:rounded-bl-[60px] nxl:rounded-bl-[100px] w3-animate-opacitys">
//           <p className="exoFont relative top-[45%]">“Quote 1” - Speaker 1</p>
//         </div>
//         <div className="quoteBG quoteBG2 mySlides h-[40vh] lg:h-[50vh] flex flex-col items-center justify-center text-center text-white text-[14px] md:text-[16px] nxl:text-[22px] px-[10vw] rounded-tr-[0px] rounded-bl-[40px] tab:rounded-bl-[60px] nxl:rounded-bl-[100px] w3-animate-opacitys">
//           <p className="exoFont relative top-[45%]">“Quote 2” - Speaker 2</p>
//         </div>
//         <div className="quoteBG quoteBG3 mySlides h-[40vh] lg:h-[50vh] flex flex-col items-center justify-center text-center text-white text-[14px] md:text-[16px] nxl:text-[22px] px-[10vw] rounded-tr-[0px] rounded-bl-[40px] tab:rounded-bl-[60px] nxl:rounded-bl-[100px] w3-animate-opacitys">
